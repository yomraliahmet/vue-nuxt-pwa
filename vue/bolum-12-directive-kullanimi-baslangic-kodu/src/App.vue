  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        ...
        <p v-color:background.delay.flash="{mainColor : 'green', secondColor : 'blue', delay : 500}">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores aspernatur beatae culpa doloribus, ex
